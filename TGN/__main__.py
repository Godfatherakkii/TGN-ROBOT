...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="Sᴜᴘᴘᴏʀᴛ!​​", url="https://t.me/GodfatherSupport"
        ),
    ],
    [
        InlineKeyboardButton(
...
EMI_IMG = "https://telegra.ph/file/f6377606f5c7627fdc3e3.png"
    ...
    if query.data == "emli_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Aʙᴏᴜᴛ Mᴇ 👩‍💻", callback_data="emli_admin"),
                    InlineKeyboardButton(text="Nᴏᴛᴇs", callback_data="emli_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="Cʀᴇᴅɪᴛ", callback_data="emli_credit"),
                 ...
                 [
                    InlineKeyboardButton(text="☜︎︎︎ Bᴀᴄᴋ", callback_data="emli_back"),
                 ]
                ]
            ),
        )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Vᴇʀ", url="https://t.me/EMLIXbot"),
                    InlineKeyboardButton(text="Sᴏᴜʀᴄᴇ", url="https://github.com/ITZ-ZAID/TGN-Robot"),
                 ],
                 [
                 ...
                 [
                    InlineKeyboardButton(text="Gɪᴛ", url="https://github.com/Godfatherakkii"),
